function SocialLinks() {
    ...
    return (
        <div className="social">
            <a className="circle-btn" href={social.twitterUrl}>
            ...
            <a className="circle-btn" href={social.gitHubUrl}>
            ...
            <a className="circle-btn" href={social.linkedInUrl}>
            ...
            <a className="circle-btn" href={social.instagramUrl}>
                <svg viewBox="0 0 19 19" width="19">
