...
function BarLink(props) {
    return <a className="circle-btn circle-btn--light" href={props.url}>{props.children}</a>;
}

function Bar(props) {
    return (
        <div className="exp-item-bar">
            <div className="exp-item-bar__content">
                {props.project && <span className="exp-item-bar__project">{props.project}</span>}
                <span className="exp-item-bar__tags tk-source-code-pro ellipsis-multiline">{props.tags.join(' / ')}</span>
            </div>
            <div className="exp-item-bar__links">
                <BarLink url={props.githubUrl}>
...
function Description(props) {
    return <div className="exp-item__desc">{props.children}</div>
}
